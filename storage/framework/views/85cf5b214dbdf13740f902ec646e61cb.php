<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/deck-detail.css')); ?>?v=20260705">
<?php $__env->stopPush(); ?>
...
<div class="dd" data-deck-detail-app data-deck-id="<?php echo e($deck->id); ?>" data-user-id="<?php echo e($deckDetailUserId ?? ''); ?>" data-total-cards="<?php echo e($cards->total()); ?>">
        ...
        <div class="dd-hero__info">
            ...
            <div class="dd-hero__text">
                <div class="dd-hero__title-row">
                    ...
                    <div class="dd-deck-switcher-wrap" data-deck-switcher-wrap>
    ...
    <form method="GET" action="<?php echo e(route('decks.show', $deck)); ?>" class="dd-toolbar">
        <div class="dd-toolbar__main">
            ...
            <div class="dd-toolbar__filters">
                <div class="dd-status-select-wrap" data-status-select-wrap>
                    <select class="dd-toolbar__select" name="status" aria-label="Filter by status" data-status-select>
    ...
    <section class="dd-table-wrap">
        <div class="dd-table-head">
            <div>
                ...
                <p class="dd-table-head__meta"><?php echo e($cards->total()); ?> total cards in this deck</p>
            </div>
    ...
    <dialog id="delete-card-modal" class="dd-modal dd-modal--compact dd-modal--danger">
        <form method="dialog" class="dd-modal__form" data-delete-card-form>
            <div class="dd-modal__header">
                ...
                <div class="dd-modal__header-copy">
                    <h2 class="dd-modal__title">Delete Card</h2>
                    <p class="dd-modal__subtitle">Remove this card from the deck permanently.</p>
                </div>
            ...
            <div class="dd-modal__body">
                <div class="dd-delete-card-alert">
                    <span class="material-symbols-outlined">error</span>
                    <p class="dd-modal__message" data-delete-modal-message>Are you sure you want to delete this card?</p>
                </div>
                <p class="dd-delete-card-note">The front, back, scheduling state, and review history for this card will be removed.</p>
                <input type="hidden" data-delete-card-id-input />
                <div class="dd-modal__feedback is-hidden" data-delete-card-form-feedback></div>
            </div>
            <div class="dd-modal__footer">
                <button type="button" class="dd-btn dd-btn--ghost" data-close-delete-modal-button>Keep Card</button>
