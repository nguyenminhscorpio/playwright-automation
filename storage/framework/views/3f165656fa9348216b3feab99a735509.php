...
<?php $__env->startSection('content'); ?>
    <section class="study-page">
        <div class="study-shell" data-study-app>
            ...
            <article class="study-card study-card--front stagger-3" data-reveal data-study-card>
            ...
            <div class="study-actions study-actions--center stagger-4" data-reveal><button class="primary-button primary-button--pill" type="button" data-study-reveal-button disabled><span class="material-symbols-outlined">visibility</span><span>Show Answer</span></button></div>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\playwright-automation\resources\views/screens/study-front.blade.php ENDPATH**/ ?>