...
<?php $__env->startSection('content'); ?>
    <section class="study-page">
        <div class="study-shell" data-study-app>
            <div class="study-progress study-progress--split stagger-1" data-reveal>
                <div>
            ...
            <article class="study-card study-card--answer stagger-2" data-reveal data-study-card>
            ...
            <section class="rating-panel stagger-3" data-reveal><p class="rating-panel__title" data-study-rating-title>How difficult was this to recall?</p><div class="rating-grid"><button class="rating-card rating-card--again" type="button" data-study-rate-button="again"><strong>1</strong><span>Again</span><small data-study-rating-again>&lt; 1 min</small></button><button class="rating-card rating-card--hard" type="button" data-study-rate-button="hard"><strong>2</strong><span>Hard</span><small data-study-rating-hard>~ 5 min</small></button><button class="rating-card rating-card--good" type="button" data-study-rate-button="good"><strong>3</strong><span>Good</span><small data-study-rating-good>~ 10 min</small></button><button class="rating-card rating-card--easy" type="button" data-study-rate-button="easy"><strong>4</strong><span>Easy</span><small data-study-rating-easy>~ 4 days</small></button></div></section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\playwright-automation\resources\views/screens/study-answer.blade.php ENDPATH**/ ?>