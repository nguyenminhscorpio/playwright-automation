...
<div class="deck-detail-container">
    <div class="card-manager-header stagger-1" data-reveal>
        <div>
            <h1 class="card-manager-title">No Deck Found</h1>
            <p class="hero__subtitle">The deck you are looking for does not exist or you don't have access to it.</p>
        </div>
        <div class="toolbar-actions">
            <a href="<?php echo e(route('dashboard')); ?>" class="primary-button">
