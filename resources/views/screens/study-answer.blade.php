...
@section('content')
    <section class="study-page">
        <div class="study-shell" data-study-app>
            <div class="study-progress study-progress--split"><div><span class="eyebrow" data-study-deck-name>{{ $studyDeckName ?? 'Study Session' }}</span><h1 class="study-title" data-study-progress-title>Current Card</h1></div><div class="progress-inline"><div class="progress progress--small"><div class="progress__bar" data-study-progress-bar style="width: 0%"></div></div><span data-study-progress-percent>0%</span></div></div>
