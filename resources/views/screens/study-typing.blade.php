...
@section('content')
    <section class="study-page">
        <div class="study-shell" data-study-app>
            <div class="study-progress study-progress--compact"><div class="progress-block__meta"><span data-study-deck-name>{{ $studyDeckName ?? 'Current Deck' }}</span><strong data-study-progress-compact>0 / 0</strong></div><div class="progress"><div class="progress__bar" data-study-progress-bar style="width: 0%"></div></div></div>
